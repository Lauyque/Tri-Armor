...
class Level:
    def __init__(self, level_data, surface,game_instance):
        ...
        self.pop_up_fin = pygame.image.load('assets\Capture_d_ecran_2024-01-18_a_15.17.06-removebg-preview.png')
        

        self.image_fond = pygame.image.load('space.png')
 ...
 # Remplacez {} par votre structure de données d'inventaire réelle
    ...
    def verification(self):
        if objets.flour.nombre == 10 and objets.water.nombre == 10 and objets.beurre.nombre == 10 and objets.egg.nombre == 10:
            ...
            pygame.mixer.music.load('Tri-Yann-Le-Loup_-le-Renard-et-la-Belette-_La-Jument-de-Michao_.mp3')  # Remplacer avec le chemin de votre fichier audio
    ...
    def complete_map(self):
        if not self.niveau_termine:
            ...
            message_victoire = pygame.image.load('assets/niveau_termine.png')
    ...
    def run(self):
        ...
        self.objet.flour = 10
        self.objets.water.nombre = 10
        self.objets.beurre.nombre = 10
        self.objets.egg.nombre = 10
